  ...
  return (
    <section className="section section--paper">
      <div className="container">
        ...
        {/* 2-sloupcový úvod: nadpis vlevo, text vpravo */}
        <div className="cols-2" data-reveal style={{ marginBottom: '3rem' }}>
          <div className="cols-2__col" style={{ display: 'flex', alignItems: 'center' }}>
            <h3 style={{ textAlign: 'left', margin: 0 }}>Příběh vodní miniZOO Baška</h3>
          </div>
        ...
        <figure style={{ margin: '2rem auto 3rem', maxWidth: 1100 }} data-reveal>
          <Image
            src={oNasImages.hero}
        ...
        <div className="prose">
          ...
          <h3 style={{ textAlign: 'left' }}>Hlavní cíle vodní miniZOO Baška</h3>
          ...
          <h3 style={{ textAlign: 'left' }}>Rozvojové a dlouhodobé cíle</h3>
          ...
          <h3 style={{ textAlign: 'left' }}>Expozice nabízí:</h3>
          <ul>
          ...
          <h3 style={{ textAlign: 'left' }}>Identifikační údaje</h3>
          <ul>
          ...
          <h3 style={{ textAlign: 'left' }}>Statutární orgán</h3>
          <p>Statutárním orgánem spolku je výbor.</p>

          <h3 style={{ textAlign: 'left' }}>Předsedkyně výboru</h3>
          <p>
