...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: siteConfig.description,
    images: [{ url: '/assets/images/arapaima.jpeg', width: 1200, height: 800, alt: siteConfig.name }],
  },
  twitter: {
    card: 'summary_large_image',
    title: siteConfig.name,
    description: siteConfig.description,
    images: ['/assets/images/arapaima.jpeg'],
  },
...
const orgJsonLd = {
  ...
  image: `${siteConfig.url}/assets/images/arapaima.jpeg`,
  description: siteConfig.description,
  url: siteConfig.url,
